...
1. Upload the entire `/givewp-cryptopay-gateway` directory to the `/wp-content/plugins/` directory.
2. Activate GiveWP - CryptoPay Gateway through the 'Plugins' menu in WordPress.
3. Enjoy.

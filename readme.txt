...
1. Upload the entire `/cryptopay-gateway-for-givewp` directory to the `/wp-content/plugins/` directory.
2. Activate CryptoPay Gateway for GiveWP  through the 'Plugins' menu in WordPress.
3. Enjoy.
